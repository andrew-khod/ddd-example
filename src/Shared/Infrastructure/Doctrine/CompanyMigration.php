...
//        $this->abortIf('mysql' !== $this->connection->getDatabasePlatform()->getName(), 'Migration can only be executed safely on \'mysql\'.');
        ...
        $this->addSql('CREATE TABLE initiative (id BINARY(16) NOT NULL, customer_id BINARY(16) NOT NULL, type VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, minimal_joined_people INT DEFAULT NULL, location POINT DEFAULT NULL COMMENT \'(DC2Type:spatial_point)\', location_radius_value NUMERIC(10, 2) DEFAULT NULL, location_radius_unit VARCHAR(255) DEFAULT NULL, date_start DATETIME NOT NULL, date_end DATETIME NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, INDEX IDX_AE48DD2E9395C3F3 (customer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
